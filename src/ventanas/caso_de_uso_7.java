 ...
 * @author Usuario
 */
public class caso_de_uso_7 extends javax.swing.JFrame {

    /**
     * Creates new form caso_de_uso_7
     */
    public caso_de_uso_7() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(caso_de_uso_7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new caso_de_uso_7().setVisible(true);
            }
        });
    }
