 ...
 * @author Marcos
 */
public class CasoDeUso03 extends javax.swing.JFrame {

    /**
     * Creates new form CasoDeUso03
     */
    public CasoDeUso03() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPaneObservaciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, 750, 230));
        ...
        getContentPane().add(jTextField1NroTicketPorPantalla, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 80, 230, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CasoDeUso03.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CasoDeUso03().setVisible(true);
            }
        });
    }
